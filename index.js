...
client.on('message', function (message) {
	if (message.content === 'Nika') {
    return message.reply("Fala ae meu consagrado")
	  }
  });
...
client.on('message', function (message) {
  if (message.content === 'Vadia') {
    return message.reply('vadia é sua mãe <:Natsu2:559225651597410328> ')
  }
});
...
client.on('message', function (message) {
  if (message.content === 'Fumar') {
    return message.reply('aqui seu fumante: 🚬 💨💨💨')
  }
});
